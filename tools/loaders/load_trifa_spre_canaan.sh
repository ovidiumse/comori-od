...
${TOOLS_DIR}/od-extract.py -i ${DATA_DIR}/trifa_spre_canaan/trifa_spre_canaan_fixed.htm -c ${CFG_DIR}/trifa_spre_canaan.yaml -a "Pr. Iosif Trifa" -v "Spre Canaan" -e ${DATA_DIR}/trifa_spre_canaan/trifa_spre_canaan.json
...
${TOOLS_DIR}/od-upload.py -i ${DATA_DIR}/trifa_spre_canaan/trifa_spre_canaan_processed.json $@